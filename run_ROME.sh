...
CKPT_PATH=\"/home/zx/nas/GitRepos/EasyEdit/results/llama2_wiki_recent_lora_ffn_r$i/checkpoint-1140\" \
RANK=$i \
OUT_NAME=\"llama2_wiki_recent_lora_ffn_edit_eval_ROME_test\" \
PROMPT_LEN=3 \
...
# CKPT_PATH="/home/zx/nas/GitRepos/EasyEdit/results/llama2_wiki_recent_lora_ffn_r32/checkpoint-1140" CUDA_VISIBLE_DEVICES=1 python test.py