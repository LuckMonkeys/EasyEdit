...
from ..rome_lora import repr_tools
...
def compute_v(
    ...
    def edit_output_fn(cur_out, cur_layer):
        ...
        if cur_layer == hparams.value_module_tmp.format(layer):
    ...
    for it in range(hparams.v_num_grad_steps):
        ...
        with nethook.TraceDict(
            ...
            layers=[
                ...
                hparams.value_module_tmp.format(layer),
            ],
            retain_input=False,
            retain_output=True,
    ...
    cur_input, cur_output = get_module_input_output_at_word(
        ...
        module_template=hparams.target_module_tmp,
...
def get_module_input_output_at_word(
    ...
    #get input of loraA and output of loraB
    #get input of loraA
    word_repr_args["module_template"] = module_template[0]
    if "subject_" in fact_token_strategy and fact_token_strategy.index("subject_") == 0:
        ...
        l_input = repr_tools.get_reprs_at_idxs(
            track="in",
    ...
    word_repr_args["module_template"] = module_template[1]
    if "subject_" in fact_token_strategy and fact_token_strategy.index("subject_") == 0:
        subtoken = fact_token_strategy[len("subject_") :]
