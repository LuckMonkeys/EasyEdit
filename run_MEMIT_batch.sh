...
# CKPT_PATH=\"/home/zx/nas/GitRepos/EasyEdit/results/llama2_wiki_recent_lora_ffn_r$i/checkpoint-1140\" \
# RANK=$i \
# OUT_NAME=\"llama2_wiki_recent_lora_ffn_edit_eval\" \
...
do
    # 构造命令，确保每个反斜杠后直接换行
    CMD="PARAMS=\"./hparams/MEMIT/llama-7b_lora_ffn_batch\" \
CKPT_PATH=\"/home/zx/nas/GitRepos/EasyEdit/results/llama2_wiki_recent_lora_ffn_r$i/checkpoint-1140\" \
RANK=$i \
OUT_NAME=\"llama2_wiki_recent_lora_ffn_edit_eval_MEMIT_batch\" \
PROMPT_LEN=3 \
python edit_and_eval_lora_ffn_batch.py"
